...
// Date: 9/11/2022
// Title: Project 3
// Project Description: The code is desgin to short the last name and first name to the user choice.
...
int main()
{
    ...
    //Setting The Counter Equal To THe GETDATA
    counter = getData(iFile1, name1);
    counter = getData(iFile2, name2);

    // User Picks What The Code Does
    int choice = 0;
    while (choice != 3)
    {
